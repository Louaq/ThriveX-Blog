        ...
        <ModalContent>
          {() => (
            <>
              ...
              <ModalBody>
                <div className="mx-auto mb-4 p-3 space-y-2 border-primary bg-[#ecf7fe] rounded-md text-sm text-black-b">
                  <p>1、网站无任何违法乱纪的内容</p>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <>
                      <Input {...field} type="text" label="网站名称" variant="bordered" placeholder="示例：louaq" isInvalid={!!errors.title?.message} errorMessage={errors.title?.message} onBlur={() => trigger('title')} classNames={{ inputWrapper }} />
                    </>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <>
                      <Textarea {...field} label="网站介绍" variant="bordered" placeholder="示例：coding" isInvalid={!!errors.description?.message} errorMessage={errors.description?.message} onBlur={() => trigger('description')} classNames={{ inputWrapper }} />
                    </>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <>
                      <Input {...field} type="text" label="图片地址" variant="bordered" isInvalid={!!errors.image?.message} errorMessage={errors.image?.message} onBlur={() => trigger('image')} classNames={{ inputWrapper }} />
                    </>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <>
                      <Input {...field} type="text" label="网站地址" variant="bordered" isInvalid={!!errors.url?.message} errorMessage={errors.url?.message} onBlur={() => trigger('url')} classNames={{ inputWrapper }} />
                    </>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <>
                      <Input {...field} type="text" label="邮箱（选填）" variant="bordered" isInvalid={!!errors.email?.message} errorMessage={errors.email?.message} onBlur={() => trigger('email')} classNames={{ inputWrapper }} />
                    </>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <>
                      <Input {...field} type="text" label="订阅地址（选填）" variant="bordered" isInvalid={!!errors.rss?.message} errorMessage={errors.rss?.message} onBlur={() => trigger('rss')} classNames={{ inputWrapper }} />
                    </>
                  )}
                />
